...
export function FloatingSupport() {
  return (
    <motion.div 
      drag
      dragMomentum={false}
      className="fixed bottom-6 right-6 z-[999] group touch-none cursor-grab active:cursor-grabbing"
    >
      <a 
      ...
      >
        <motion.div
          ...
          whileTap={{ scale: 0.95 }}
          className="w-14 h-14 rounded-full bg-brand-blue flex items-center justify-center text-white shadow-[0_0_20px_rgba(0,112,243,0.4)] border-2 border-white dark:border-[#030303] relative"
        >
