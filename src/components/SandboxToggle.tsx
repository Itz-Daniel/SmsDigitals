...
import { Flask, Check, Info } from "@phosphor-icons/react";
...
export function SandboxToggle() {
  const { isSandbox, toggleSandbox } = useSandboxMode();
  ...
  return (
    <div className="flex items-center gap-2 bg-purple-500/10 dark:bg-purple-500/20 border border-purple-500/30 px-3.5 py-1.5 rounded-2xl">
      ...
      <div className="flex flex-col">
        <span className="text-[10px] uppercase tracking-wider font-extrabold text-purple-600 dark:text-purple-300">
          Sandbox Mode
        </span>
      ...
      <button
        ...
        title="Toggle Sandbox Mode for Free Testing"
      >
        <span
